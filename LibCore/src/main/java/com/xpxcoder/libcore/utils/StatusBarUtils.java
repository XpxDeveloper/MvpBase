...
public class StatusBarUtils {
    ...
    public static void showNotificationBar(Context context, boolean isSettingPanel) {
        @SuppressLint("ObsoleteSdkInt") String methodName = (Build.VERSION.SDK_INT <= 16) ? "expand"
     ...
     */
    public static void setWindowStatusBarColor(Activity activity, int color, boolean isFontColorDark, boolean isDraw) {
