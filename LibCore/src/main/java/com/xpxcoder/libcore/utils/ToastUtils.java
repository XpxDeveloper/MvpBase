...
public final class ToastUtils {
    ...
    private static void showToast(CharSequence text, int duration) {
        ...
        if (sToast == null) {
            ...
            View view =
                    LayoutInflater.from(Utils.getContext()).inflate(R.layout.custom_common_toast, null);
     ...
     * toast 自定义
     */
    public static Toast getToastFree(CharSequence text, int duration, int drawableId) {
        sToast = Toast.makeText(Utils.getContext(), text, duration);
        LinearLayout toastView = (LinearLayout) LayoutInflater.from(Utils.getContext()).inflate(R.layout.toast_free, null);
        ...
        sToast.setGravity(Gravity.CENTER | Gravity.FILL_HORIZONTAL, 0, 0);
